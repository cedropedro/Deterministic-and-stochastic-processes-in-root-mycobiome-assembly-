# Description: PERMANOVA comparing communities along a gradient in Mean Annual Precipitation
...
# Changes accross space

# OTU table
OTU.table <- read.csv("OTU_Table_NoSingleandDoubletons.csv")

# Mapping file
mapping <- read.csv("Mapping_file_2019_2020.csv")
...
# Adonis function
adonis_Spatial <-adonis2(data.dist ~ mapping$MAP2.clim*mapping$Location+mapping$Transect:mapping$Location, permutations=9999)
adonis_Spatial
